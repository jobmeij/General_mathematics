% Derive_LE_eq_PP_system_v00.m
%
% Derive Lagrange-Euler equations for of R(evolute)P(rismatic) multi-body system
...
q = [q_1; q_2];                           % generalized coordinates (joint motions)
qd = [qd_1; qd_2];                        % joint speeds
qdd = [qdd_1; qdd_2];                     % joint accelerations

%% Create Inertial Parameters in symbolic form
m = [m_1; m_2];                           % masses of the links
...
R_0{1} = Rz_theta(q_1,3);                      % orientation of o1_x1_y1_z1 relative to the fixed frame o0_x0_y0_z0
R_2_1 = eye(3);                                % orientation of o2_x2_y2_z2 relative to o1_x1_y1_z1

R_0{2} = simplify(R_0{1} * R_2_1);             % orientation of o2_x2_y2_z2 relative to the fixed frame o0_x0_y0_z0

%% Translational kinematics
o_0{1} = [0; 0; 0];                            % coordinates of the origin of o1_x1_y1_z1 expressed in the fixed frame o0_x0_y0_z0
o_0{2} = o_0{1} + R_0{1}*[l_1; q_2; 0];        % coordinates of the origin of o2_x2_y2_z2 expressed in the fixed frame o0_x0_y0_z0

P_0  = o_0{2} + R_0{2}*[l_2; 0; 0];            % coordinates of the end-point expressed in the fixed frame o0_x0_y0_z0 (forward translational kinematics)
...
for k = 1 : 2,
    Rd_0{k} = diff(R_0{k},q_1)*qd_1 + diff(R_0{k},q_2)*qd_2;                          % chain rule for time-derivative: compute a sum of products
...
Tau = sym(zeros(2,1));   % create 2x1 vector of Lagrange-Euler equations (initialize with zeros)
for k = 1 : 2,
